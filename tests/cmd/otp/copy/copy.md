...
$ PASEJO_CONFIG=config.toml pasejo otp copy unique-name new-name

$ PASEJO_CONFIG=config.toml pasejo otp copy sub/name deeply/nested/name/for/password --quiet

$ PASEJO_CONFIG=config.toml pasejo otp copy deeply/nested/name/for/password here-it-is --verbose
