...
$ PASEJO_CONFIG=config.toml pasejo otp move unique-name new-name

$ PASEJO_CONFIG=config.toml pasejo otp move sub/name deeply/nested/name/for/password --quiet
