...
```console
$ PASEJO_CONFIG=config.toml pasejo store init --path path/to/somewhere --name some-name --default --vcs none
...
```console
$ PASEJO_CONFIG=config.toml pasejo store init --path path/to/someplace --name some-place --vcs none
