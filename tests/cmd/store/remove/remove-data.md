...
$ pasejo store remove something --remove-data 
Store 'something' removed

$ pasejo store add --path store --name another
Store 'another' added at '[CWD]/store'

$ pasejo store remove --remove-data another
Store 'another' removed
